app.controller("sobreCtrl", function ($rootScope, $route, $scope, $http, $location, $filter, $routeParams) {
	...
	$scope.analistas = [
    	...
    	{
    		img: "Anahy Fagundes Dias Fonseca.jpg",
		...
		{
    		img: "Benigna Jussara Gandolfi.jpg",
    	...
    	{
    		img: "Eliane Berenice Frota Luconi.jpg",
        ...
        {
            img: "Kátia A Rodrigues Ferreira.jpg",
    	...
    	{
    		img: "Maria Denise Leal Vargas.jpg",
    	...
    	{
    		img: "Maytê Cristina Da Cruz Romero.jpg",
    	...
    	{
    		img: "Roberto Fábio Lehmkuhl.jpg",
    	...
    	{
    		img: "Rosa Brizola Felizardo.jpg",
    	...
    	{
    		img: "Rosa Valente Corrêa Pinto.jpg",
	...
	*/
    ...
    $scope.diretores = [
    	...
    	{
    		img: "Jussara Gandolfi, Corina Post e Rosa Valente Corrêa Pinto.jpg",
    		cargo: "Conselheiros",
    	...
    	{
    		img: "Jussara Gandolfi e Laudeci Saldivia.jpg",
    		cargo: "Biblioteca",
    	...
    	{
    		img: "Corina Post e Rosa Brizola.jpg",
    	...
    	{
    		img: "Anita Mussi e Joyce Werres.jpg",
	...
	$scope.profissionais = [
    	...
    	},
    	{
			...
			img: "Aline Machado Oliveira.jpg",
    	...
    	},
    	{
			...
			img: "Heloisa Helena Bartholomay.jpg",
    	...
    	},
    	{
			...
			img: "Patricia Flores de Medeiros.jpg",
    	...
    	},
    	{
			...
			img: "Rose Mary Kerr de Barros.jpg",
